...
其中，<font color="red">原点</font>可以省略，默认为原图片的4个顶点。如：`【透视变换@【变量@img】@【数组@0@0@330@0@330@330@0@330】】`，效果一样。<br />
透视变换也可很容易的用于图片缩放，所以，不再单独设计图片缩放指令。
